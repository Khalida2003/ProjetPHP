    ...
    <div class="container">
      ...
      <main>
        <div class="main__container">
          <?php
          if($page1 <0 ) header("location:listeproduits.php");
          $select_produits = "SELECT * FROM produit limit $page1,5";
          $result = mysqli_query($link,$select_produits) or die(mysqli_error($link));
          $produits = mysqli_fetch_all($result,MYSQLI_ASSOC);
          ?>
          <div class="ajouterProduit">
              <a href="Ajouter_Produit.html" ><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 341.4 341.4" style="enable-background:new 0 0 341.4 341.4;" xml:space="preserve"><g><g><polygon points="192,149.4 192,0 149.4,0 149.4,149.4 0,149.4 0,192 149.4,192 149.4,341.4 192,341.4 192,192 341.4,192     341.4,149.4   "/></g></g></svg>&nbsp;&nbsp;AJOUTER</a>
          </div>
        <table >
          <tr class="first">
                <td>num Produit</td>
