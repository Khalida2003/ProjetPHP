...
$_SESSION['nomClient']=$_GET['Client'];
    ...
    <div class="container">
      <nav class="navbar">
        ...
        <div class="navbar__left">
          ...
          <a class="active_link" href="index.php">Admin</a>
        </div>
        ...
        <div class="main__container">
          ...
          <div class="main__title">
            ...
            <div class="main__greeting">
              ...
              <h1>C'est l'utilisateur : <?php echo  $_SESSION['nomClient'];?></h1>
              <p>Vous trouvez ici tout les information.</p>
            </div>
          </div>
...
$userComande=$bdd -> prepare ("SELECT * FROM commande WHERE usernameClient =? AND statut ='commander'"
);
$userComande->execute(array($_SESSION['UserName']));
...
?> 
            ...
            <div class="card"> 
              ...
              <h6> Numero Produit:
                  <?php echo $donnees['numProduit'];?></h6>
                  <h6> Quantite:
                  <?php echo $donnees['qte_demande'];?></h6>
